                            ...
                            cuisineMockData.map((cuisine) => (
                                <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-2 border-bottom">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <button type="button" className="btn btn-outline-primary me-2">Quantity</button>
                                            <button type="button" className="btn btn-outline-primary me-2">Delete</button>
                                            <button type="button" className="btn btn-outline-primary me-2">Save for later</button>
                                        </div>
                                    </div>
