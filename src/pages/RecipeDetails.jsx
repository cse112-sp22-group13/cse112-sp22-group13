...
class RecipeDetails extends React.Component {
    ...
    readIngredients() {
        ...
        for (
            let i = 0;
            i < this.state.recipeJSON.extendedIngredients.length;
            i++
        ) {
            ingredients +=
                this.state.recipeJSON.extendedIngredients[i].original;
            ingredients += "\n";
        }
        return ingredients;
    }
    ...
    readInstructions() {
        if (this.state.recipeJSON.analyzedInstructions.length == 0) {
            ...
            for (
                let i = 0;
                i < this.state.recipeJSON.analyzedInstructions;
                i++
            ) {
                ...
                <div className="recipe-page">
                    ...
                    <div className="recipe-container">
                        ...
                        <div className="recipe-image">
                            <img
                                src={this.state.recipeJSON.image}
                                alt="new"
                                width="350"
                                height="250"
                            ></img>
