...
```
Schema of options object to be passed in to complexSearch_c constructor (not all of the params have to be set, and they shouldn't be all set. Just use what you need)
```
let options = {
         method: 'GET',
